                ...
                <div class ="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistic-block block">
                            <div class="progress-details d-flex align-items-end justify-content-between">
                                <div class="title">
                                    <div class="icon"><i class="icon-contract"></i></div><strong>Total Products</strong></div>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistic-block block">
                            <div class="progress-details d-flex align-items-end justify-content-between">
                                <div class="title">
                                    <div class="icon"><i class="icon-contract"></i></div><strong>Total Order</strong></div>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistic-block block">
                            <div class="progress-detils d-flex align-items-end justify-content-between">
                                <div class="title">
                                ...
                                <div class="progress progress-template">
                                    ...
                                    aria-valuemin="0" aria-valuemax="100" cclass="progress-bar
                                    progress-bar-template dashbg-2"></div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="footer">
            <div class="footer__block block no-margin-bottom">
                <div class="container-fluid text-center">
                    ...
                    href="https:\\templateshub.net">Templates Hub</a>.</p>
                </div>
            </div>
        </footer>